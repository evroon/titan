...
struct ConstructorBuilder
{
	...
	{
		return [](Variant arg_0) { return new T(ARG_0(arg_0)); };
	}
	template<typename T, typename ARG_0, typename ARG_1>
	static std::function<Variant(Variant, Variant)> build_2_overloaded()
	{
		return [](Variant arg_0, Variant arg_1) { return new T(ARG_0(arg_0), ARG_1(arg_1)); };
	}
	...
	{
		return [](Variant arg_0, Variant arg_1, Variant arg_2) { return new T(ARG_0(arg_0), ARG_1(arg_1), ARG_2(arg_2)); };
	}
	...
	{
		return [](Variant arg_0, Variant arg_1, Variant arg_2, Variant arg_3) { return new T(ARG_0(arg_0), ARG_1(arg_1), ARG_2(arg_2), ARG_3(arg_3)); };
	}
};

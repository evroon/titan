...
void TransformField::position_items()
{
	...
	size.set_margins(0, size_size.y + margin[1] + size_pos.y + margin[0], 0, margin[1] + size_pos.y + margin[0]);
	rotation.set_margins(0, size_rotation.y + margin[2] + size_size.y + margin[1] + size_pos.y + margin[0], 0, margin[2] + size_size.y + margin[1] + size_pos.y + margin[0]);
}

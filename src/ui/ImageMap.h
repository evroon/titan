...
public:
	ImageMap();
	ImageMap(Texture2D *p_texture, SplitProperties::TexCoords p_tex_coords, SplitProperties::Positions p_positions);
	~ImageMap() { }

	void notification(int p_notification) override;

	void build(Texture2D * p_texture, SplitProperties::TexCoords p_tex_coords, SplitProperties::Positions p_positions);
	void build();

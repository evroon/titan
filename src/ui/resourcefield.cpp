...
vec2 Texture2DField::get_required_size() const { return vec2(100, 40); }
...
void ObjectField::init() {
    ...
    if (get_value().isdef()) image_path = "solid/wrench";
...
vec2 ShaderField::get_required_size() const { return vec2(); }

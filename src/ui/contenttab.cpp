...
ContentTab::ContentTab(const File &p_file) {
    ...
    directory_icon =
        CONTENT->LoadFontAwesomeIcon("regular/folder-open", vec2i(128, 128));
    file_icon =
        CONTENT->LoadFontAwesomeIcon("regular/file-code", vec2i(100, 100));
...
void ContentTab::go_home() { go_to(home); }

...
int TileElement::get_index() { return index; }
...
int TileView::get_selected() const { return selected; }

void TileView::move_selected_begin() { set_selected(0); }

void TileView::move_selected_end() { set_selected(items.size() - 1); }

...
class mat4 {
   public:
    ...
    void rotate(const vec3& axis, float angle) {
        ...
        float ys = v.y * s;
        float zs = v.z * s;
        m[0] = (1.0f - c) * xx + c;  m[4] = (1.0f - c) * xy - zs; m[8] = (1.0f -
        c)
        * zx + ys; m[12] = 0.0; m[1] = (1.0f - c) * xy + zs; m[5] = (1.0f - c) *
        yy
        + c;  m[9] = (1.0f - c) * yz - xs; m[13] = 0.0; m[2] = (1.0f - c) * zx -
        ys; m[6] = (1.0f - c) * yz + xs; m[10] = (1.0f - c) * zz + c; m[14] =
        0.0; m[3] = 0.0;                  m[7] = 0.0;                  m[11] =
        0.0; m[15] = 1.0;*/
    }

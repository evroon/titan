...
void Material::set_shader(Shader * p_shader)
{
	shader = p_shader;
}
...
Color Material::get_diffuse_color() const
{
...
Color Material::get_specular_color() const
{
...
Color Material::get_ambient_color() const
{
...
Color Material::get_emissive_color() const
{
...
Texture2D* Material::get_diffuse_texture() const
{
	return diffuse_texture;
}

Texture2D* Material::get_specular_texture() const
{
	return specular_texture;
}

Texture2D* Material::get_ambient_texture() const
{
	return ambient_texture;
}

Mesh* Material::get_mesh() const
{
	return mesh;
}

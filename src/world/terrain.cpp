...
void TerrainBrush::apply() { to_apply = true; }
...
float TerrainBrush::get_radius() const { return radius; }

void TerrainBrush::set_deviation(float p_deviation) { deviation = p_deviation; }
...
Color TerrainBrush::get_color() const { return color; }

void TerrainBrush::set_strength(float p_strength) { strength = p_strength; }
...
void Terrain::bind_methods() { REG_CSTR(0); }
...
void Water::bind_methods() { REG_CSTR(0); }

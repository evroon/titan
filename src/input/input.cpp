...
void Input::enable_text_input() { SDL_StartTextInput(); }

void Input::disable_text_input() { SDL_StopTextInput(); }

void Input::Free() { events.clean(); }

#undef CLASSNAME
#define CLASSNAME Input

void Input::bind_methods() { REG_SINGLETON(singleton); }
